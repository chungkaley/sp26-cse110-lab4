...
11. The function returns [50, 100, 150]. Although discounted is a const, no errors occurs because we are mutating the contents of the array with push() rather than reassigning the variable to a new memory address. 
